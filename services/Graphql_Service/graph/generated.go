...
type ComplexityRoot struct {
	...
	Mutation struct {
		SignInOnlyEmployee func(childComplexity int, email string, password string) int
	}
...
type MutationResolver interface {
	SignInOnlyEmployee(ctx context.Context, email string, password string) (*model.AuthPayload, error)
}
...
func (e *executableSchema) Complexity(typeName, field string, childComplexity int, rawArgs map[string]any) (int, bool) {
	...
	case "Mutation.signInOnlyEmployee":
		...
		return e.complexity.Mutation.SignInOnlyEmployee(childComplexity, args["email"].(string), args["password"].(string)), true
...
func (ec *executionContext) field_Mutation_signInOnlyEmployee_args(ctx context.Context, rawArgs map[string]any) (map[string]any, error) {
	var err error
	args := map[string]any{}
	arg0, err := ec.field_Mutation_signInOnlyEmployee_argsEmail(ctx, rawArgs)
	if err != nil {
		return nil, err
	}
	args["email"] = arg0
	arg1, err := ec.field_Mutation_signInOnlyEmployee_argsPassword(ctx, rawArgs)
	if err != nil {
		return nil, err
	}
	args["password"] = arg1
...
func (ec *executionContext) field_Mutation_signInOnlyEmployee_argsEmail(
	ctx context.Context,
...
func (ec *executionContext) field_Mutation_signInOnlyEmployee_argsPassword(
	ctx context.Context,
	rawArgs map[string]any,
) (string, error) {
...
func (ec *executionContext) _AuthPayload_error(ctx context.Context, field graphql.CollectedField, obj *model.AuthPayload) (ret graphql.Marshaler) {
	fc, err := ec.fieldContext_AuthPayload_error(ctx, field)
	if err != nil {
		return graphql.Null
	}
	ctx = graphql.WithFieldContext(ctx, fc)
...
func (ec *executionContext) _Mutation_signInOnlyEmployee(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	...
	resTmp, err := ec.ResolverMiddleware(ctx, func(rctx context.Context) (any, error) {
		ctx = rctx // use context from middleware stack in children
		return ec.resolvers.Mutation().SignInOnlyEmployee(rctx, fc.Args["email"].(string), fc.Args["password"].(string))
	})
	if err != nil {
		ec.Error(ctx, err)
		return graphql.Null
	...
	fc.Result = res
	return ec.marshalNAuthPayload2ᚖGraphql_ServiceᚋgraphᚋmodelᚐAuthPayload(ctx, field.Selections, res)
}
...
func (ec *executionContext) marshalNAuthPayload2Graphql_ServiceᚋgraphᚋmodelᚐAuthPayload(ctx context.Context, sel ast.SelectionSet, v model.AuthPayload) graphql.Marshaler {
	return ec._AuthPayload(ctx, sel, &v)
}

func (ec *executionContext) marshalNAuthPayload2ᚖGraphql_ServiceᚋgraphᚋmodelᚐAuthPayload(ctx context.Context, sel ast.SelectionSet, v *model.AuthPayload) graphql.Marshaler {
	if v == nil {
